...
<section>
			 <style>.post-wrapper-parent {margin-top: 0px !important;}.zc a{color:#444}#thearchivelist a{color:#555} #thearchivelist{ width: 210px;float:left; }   #thearchivelist ul li{ list-style:none; border-bottom:1px solid #f6f6f6;padding: 3px 0;font-size:13px } #thearchivelist ul h4{ font-weight:bold;font-size:16px !important;padding: 0 3px 0 0 !important;margin: 0px 0 5px 0 !important;border-bottom: 1px solid #ddd } #thearchivelist ul,.zc ul {margin:7px 0 0 10px;}.zc ul {list-style: none;} 
			 .zc ul li {list-style: circle; border-bottom:1px solid #eee;padding: 7px 0;font-size:13px} .zc{width: 635px;float:right;}</style>
<div id="thearchivelist">
<ul><h4><?php _e("Páginas", "mm"); ?>:</h4>
<?php wp_list_pages('title_li='); ?>
</ul>
<br /> 
<ul><h4><?php _e("Por Mes", "mm"); ?>:</h4>
<?php wp_get_archives('type=monthly'); ?>
</ul>
<br />
<ul><h4><?php _e("Por Categoría", "mm"); ?>:</h4>
