...
<?php if ( have_comments() ) : ?>
	<h3 class="numberofcomments"><span><?php comments_popup_link( __( 'No hay comentarios', 'mm' ), __( '1 Comment', 'mm' ), __( '% Comments', 'mm' ) ); ?> <?php _e("so far. Feel free to join this conversation.", "mm"); ?></span></h3>
...
<?php if ( comments_open() ) : ?>
<div id="respond"> 
	<h3><?php comment_form_title( __('Deje una respuesta','mm' ) ); ?></h3>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
		...
		<div id="comment-textarea-admin">
			<label for="comment"><?php _e("COMENTARIO", "mm"); ?></label>
			<textarea name="comment" id="comment" cols="50" rows="4" tabindex="4" class="textarea-comment"></textarea>
		</div>
		<div id="comment-submit-admin">
			<p><input name="submit" type="submit" id="submitcomment" tabindex="5" value=" <?php _e("PUBLICA UN COMENTARIO", "mm"); ?> " class="comment-submit" /></p>
