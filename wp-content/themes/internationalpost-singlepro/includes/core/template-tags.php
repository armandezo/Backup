...
if ( function_exists( 'wp_nav_menu' ) ){
	if (function_exists('add_theme_support')) {
		...
		'first' => __( 'Top Menu', 'first' ),
	) );
           register_nav_menus( array( 
		'second' => __( 'Trending Menu', 'second' ),
	) );		
           register_nav_menus( array( 
...
function primarymenu2(){ ?>
			<div class="top-trending">
			 <div style="color:#000"><?php _e(" Go to DASHBOARD > Appearance > Menus to set up the menu.", "mm"); ?></div> 
			</div> 
<?php }
function primarymenu3() { ?>
			<div id="menu-22"> 
				<ul id="menu-menu" class="menu"><li><div><?php _e(" Go to DASHBOARD > Appearance > Menus to set up the menu.", "mm"); ?></div></li></ul>
			</div>
<?php }
