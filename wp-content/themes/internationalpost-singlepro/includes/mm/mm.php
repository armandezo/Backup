...
"desc" => __('<b>Upload Logo: </b> Upload your own Logo to use as Site Logo. (for bestfit: 404px x 36px)
<br /><br />
...
$options[] = array( "name" => __('Breaking News Slider','mm'), 
"desc" => __('<b>Breaking News Slider:</b> Turn ON or OFF Slider<br /><br />
 <b>Breaking News Category:</b> This slider show posts from selected category, So you can select the category here. <br />
','mm'),
						"id"=>"subhead_f_slider",
						"type" => "subhead");  					
						  
	$options[] = array( "name" => __('Breaking News Slider on Header','mm'),
						"id" => $shortname."_top_slider",
						"type" => "checkbox",                                        
						"std" => "true"); 	


  	$options[] = array( "name" => __('Breaking News Category','mm'),
						"id" => $shortname."_top_slider_cat",
						"type" => "select", 
...
$options[] = array( "name" => __('Featured Slider','mm'), 
...
','mm'),
	...
	$options[] = array( "name" => __('Featured Slider','mm'),
  	...
  	$options[] = array( "name" => __('Featured Slider Category','mm'),
						"id" => "slider_cats_area",
						"type" => "select", 
						"options" => $options_categories);		                       
	
$options[] = array( "name" => __('Latest News (on the right side of slider)','mm'), 
"desc" => __(' 
 <b>Latest News (on the right side of slider):</b> This slider show posts from selected category, So you can select the category here. To show the recent posts, select None <br /> <br />
 <b>Show Posts in Post Sidebar:</b> Show how many post you want to display in Post Sidebar next to Featured Slider  <br />
','mm'),
						"id"=>"subhead_f_area",
						"type" => "subhead");  
  	...
  	$options[] = array( "name" => __('Latest News (on the right side of slider)','mm'),
						"id" => "featured_area_sidebar",
						"type" => "select", 
						"options" => $options_categories);	

   	$options[] = array( "name" => __('Show Posts in Post Sidebar','mm'),
				    	"id" => $shortname."_sidebarpost_number",
				    	"type" => "text",
				    	"std" => "12",); 

$options[] = array( "name" => __('Featured Area','mm'), 
"desc" => __('<b>Featured Area:</b> Turn ON or OFF Featured Area. <br /><br />
 <b>Featured Area Category:</b> This area show posts from selected category, So you can select the category here. <br />
','mm'),
						"id"=>"subhead_f_slider",
						"type" => "subhead");  					
						  
	$options[] = array( "name" => __('Featured Area','mm'),
						"id" => $shortname."_featured_area_on_off",
						"type" => "checkbox",                                        
						"std" => "true"); 	


  	$options[] = array( "name" => __('Featured Area Category','mm'),
						"id" => "featured_area_1",
						"type" => "select", 
						"options" => $options_categories);		
 ...
 $options[] = array( "name" => __('Blocks','mm'),
					"id"=>"blocks",
					"type" => "section",
					"icon" => "document_layout.png");
$options[] = array( "type" => "open");
...
$options[] = array( "name" => __('Block #1','mm'),
						"id"=>"subhead_block1",
						"desc" => __('<b>Block #1:</b> Turn ON or OFF Block #1<br /><br />
<b>Block #1 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #1 Color:</b> Change Block #1  (Default Color is #0678B0)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #1','mm'),
						"id" => $shortname."_b1_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #1 Category','mm'),
						"id" => "b1_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #1 Color','mm'),
                        "id" => $shortname."_b1_color",
                        "type" => "colorpicker",
                        "std" => "#0678B0");
                        
$options[] = array( "name" => __('Block #2','mm'),
						"id"=>"subhead_block2",
						"desc" => __('<b>Block #2:</b> Turn ON or OFF Block #2<br /><br />
<b>Block #2 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #2 Color:</b> Change Block #2  (Default Color is #F23D6D)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #2','mm'),
						"desc" => __('Turn ON or OFF Block #2','mm'),
						"id" => $shortname."_b2_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #2 Category','mm'),
						"desc" => "",
						"id" => "b2_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #2 Color','mm'),
                        "desc" =>  __('Change Block #2  (Default Color is #F23D6D)','mm'),
                        "id" => $shortname."_b2_color",
                        "type" => "colorpicker",
                        "std" => "#F23D6D"); 

                        
$options[] = array( "name" => __('Block #3','mm'),
						"id"=>"subhead_block3",
						"desc" => __('<b>Block #3:</b> Turn ON or OFF Block #3<br /><br />
<b>Block #3 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #3 Color:</b> Change Block #3 (Default Color is #0f0f0f)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #3','mm'),
						"desc" => __('Turn ON or OFF Block #3','mm'),
						"id" => $shortname."_b3_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #3 Category','mm'),
						"desc" => "",
						"id" => "b3_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #3 Color','mm'),
                        "desc" =>  __('Change Block #3 (Default Color is #0f0f0f)','mm'),
                        "id" => $shortname."_b3_color",
                        "type" => "colorpicker",
                        "std" => "#0f0f0f");
                        
$options[] = array( "name" => __('Block #4','mm'),
						"id"=>"subhead_block4",
						"desc" => __('<b>Block #4:</b> Turn ON or OFF Block #4<br /><br />
<b>Block #4 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #4 Color:</b> Change Block #4  (Default Color is #A71E24)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #4','mm'),
						"desc" => __('Turn ON or OFF Block #4','mm'),
						"id" => $shortname."_b4_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #4 Category','mm'),
						"desc" => "",
						"id" => "b4_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #4 Color','mm'),
                        "desc" =>  __('Change Block #4  (Default Color is #A71E24)','mm'),
                        "id" => $shortname."_b4_color",
                        "type" => "colorpicker",
                        "std" => "#A71E24");

                        
$options[] = array( "name" => __('Block #5','mm'),
						"id"=>"subhead_block5",
												"desc" => __('<b>Block #5:</b> Turn ON or OFF Block #5<br /><br />
<b>Block #5 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #5 Color:</b> Change Block #5  (Default Color is #0090F0)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #5','mm'),
						"desc" => __('Turn ON or OFF Block #5','mm'),
						"id" => $shortname."_b5_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #5 Category','mm'),
						"desc" => "", 
						"id" => "b5_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #5 Color','mm'),
                        "desc" =>  __('Change Block #5  (Default Color is #0090F0)','mm'),
                        "id" => $shortname."_b5_color",
                        "type" => "colorpicker",
                        "std" => "#0090F0");

                        
$options[] = array( "name" => __('Block #6','mm'),
						"id"=>"subhead_block6",
												"desc" => __('<b>Block #6:</b> Turn ON or OFF Block #6<br /><br />
<b>Block #6 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #6 Color:</b> Change Block #6 (Default Color is #F8699B)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #6','mm'),
						"desc" => __('Turn ON or OFF Block #6','mm'),
						"id" => $shortname."_b6_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #6 Category','mm'),
						"desc" => "",
						"id" => "b6_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #6 Color','mm'),
                        "desc" =>  __('Change Block #6  (Default Color is #F8699B)','mm'),
                        "id" => $shortname."_b6_color",
                        "type" => "colorpicker",
                        "std" => "#F8699B");

                        
$options[] = array( "name" => __('Block #7','mm'),
						"id"=>"subhead_block7",
							"desc" => __('<b>Block #7:</b> Turn ON or OFF Block #7<br /><br />
<b>Block #7 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #7 Color:</b> Change Block #7 (Default Color is #FA5F00)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #7','mm'),
						"desc" => __('Turn ON or OFF Block #7','mm'),
						"id" => $shortname."_b7_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #7 Category','mm'),
						"desc" => "",
						"id" => "b7_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #7 Color','mm'),
                        "desc" =>  __('Change Block #7  (Default Color is #FA5F00)','mm'),
                        "id" => $shortname."_b7_color",
                        "type" => "colorpicker",
                        "std" => "#FA5F00");
                        
$options[] = array( "name" => __('Block #8','mm'),
						"id"=>"subhead_block8",
							"desc" => __('<b>Block #8:</b> Turn ON or OFF Block #8<br /><br />
<b>Block #8 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #8 Color:</b> Change Block #8 (Default Color is #3FAF17)<br />
','mm'),
						"type" => "subhead"); 


	$options[] = array( "name" => __('Block #8','mm'),
						"desc" => __('Turn ON or OFF Block #8','mm'),
						"id" => $shortname."_b8_on_off",
						"type" => "checkbox",                                        
						"std" => "true");                        
  	$options[] = array( "name" => __('Block #8 Category','mm'),
						"desc" => "",
						"id" => "b8_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #8 Color','mm'),
                        "desc" =>  __('Change Block #8  (Default Color is #3FAF17)','mm'),
                        "id" => $shortname."_b8_color",
                        "type" => "colorpicker",
                        "std" => "#3FAF17");
                        
                        
$options[] = array( "name" => __('Block #9','mm'),
						"id"=>"subhead_block9",
							"desc" => __('<b>Block #9:</b> Turn ON or OFF Block #9<br /><br />
<b>Block #9 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #9 Color:</b> Change Block #9 (Default Color is #17b091)<br />
','mm'),
						"type" => "subhead"); 

	$options[] = array( "name" => __('Block #9','mm'),
						"desc" => __('Turn ON or OFF Block #9','mm'),
						"id" => $shortname."_b9_on_off",
						"type" => "checkbox",                                        
						"std" => "false");                        
  	$options[] = array( "name" => __('Block #9 Category','mm'),
						"desc" => "", 
						"id" => "b9_cat",
						"type" => "select", 
						"options" => $options_categories);	                        
    $options[] = array( "name"  => __('Block #9 Color','mm'),
                        "desc" =>  __('Change Block #9  (Default Color is #17b091)','mm'),
                        "id" => $shortname."_b9_color",
                        "type" => "colorpicker",
                        "std" => "#17b091");
                        
                        
$options[] = array( "name" => __('Block #10','mm'),
						"id"=>"subhead_block10",
							"desc" => __('<b>Block #10:</b> Turn ON or OFF Block #10<br /><br />
<b>Block #10 Category:</b> This Block show posts from selected category, So you can select the category here. <br /><br />
<b>Block #10 Color:</b> Change Block #10 (Default Color is #912DAA)<br />
','mm'),
						"type" => "subhead");                    


	$options[] = array( "name" => __('Block #10','mm'),
						"desc" => __('Turn ON or OFF Block #10','mm'),
						"id" => $shortname."_b10_on_off",
						"type" => "checkbox",                                        
						"std" => "false");                        
  	$options[] = array( "name" => __('Block #10 Category','mm'),
						"desc" => "",
						"id" => "b10_cat",
						"type" => "select", 
						"options" => $options_categories);	                         
    $options[] = array( "name"  => __('Block #10 Color','mm'),
                        "desc" =>  __('Change Block #10  (Default Color is #912DAA)','mm'),
                        "id" => $shortname."_b10_color",
                        "type" => "colorpicker",
                        "std" => "#912DAA");
...
"desc" => __('Enable & Disable to show or hide the Specific button. Another input area is for adding your profile url. These are very easy options so i hope you will understand them.','mm'),
    	...
    	$options[] = array( "name" => __('Reddit','mm'),
						"desc" => __('Turn ON or OFF Reddit Logo','mm'),
						"id" => $shortname."_social3_on_off",
						"type" => "checkbox",
						);

    	$options[] = array( "name" => __('Reddit Profile Url','mm'),
...
$options[] = array( "name" => __('Ads','mm'),
 ...
 $options[] = array( "name" => __('Blocks info','mm'),
       ...
       $options[] = array(   
        ...
        $options[] = array( "name" => __('Advertisement Slot #7 ','mm'),
		      				"desc" => __('Turn ON or OFF Advertisement Slot 7','mm'),
		      				"id" => $shortname."_ad_7_on_off",
		      				"type" => "checkbox", ); 
       $options[] = array(   
                            "desc" => __('Above the footer','mm'),
				            "id" => $shortname."_ad_7",
        ...
        $options[] = array( "name" => __('Advertisement Slot #8 ','mm'),
		      				"desc" => __('Turn ON or OFF Advertisement Slot 8','mm'),
		      				"id" => $shortname."_ad_8_on_off",
		      				"type" => "checkbox", ); 
       $options[] = array(   
                            "desc" => __('Above the footer','mm'),
				            "id" => $shortname."_ad_8",
