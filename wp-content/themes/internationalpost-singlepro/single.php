...
<div class="single-meta">
	<div class="metainfoleft"> 
		<div class="info">
			<?php _e("Publicado el", "mm"); ?>  <span class="date"> <?php the_time('M j Y - g:ia') ?>  </span>
			<?php _e("Por", "mm"); ?>   <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="
	...
	<div class="single-pagi"> 
		<div class="prev-nav"> <?php previous_post ( "%",esc_attr__( '&laquo; ANTERIOR ','mm') , "<br />", "yes", "mm"); ?></div> | 
		<div class="next-nav"> <?php next_post ( "%",esc_attr__( 'PRÓXIMA &raquo;', 'mm'),  "<br />", "yes", "mm"); ?></div> 
		<div class="cb"></div>
	</div>
	<div class="cb"></div>
</div>
...
<div class="authorareah3-img"><?php _e("ACERCA DEL AUTOR", "mm"); ?></div> 
<div style="float: left;"><?php the_author_posts_link(); ?></div>
<div class="cb"></div></div> 
<div style="float: left; padding:0 5px 2px 0px"><a href="<?php bloginfo('url'); ?>/author/<?php the_author_meta('nickname'); ?>"><?php if (function_exists('get_avatar')) { echo get_avatar( get_the_author_meta('email'), '60' ); }?></a></div>
...
<script type="text/javascript" src="http://s7.addthis.com/js/300/addthis_widget.js"></script>
 <div id="sharebox">
	<div class="wdt"><a class="addthis_button_tweet" tw:count="vertical" addthis:url="<?php the_permalink(); ?>" addthis:title="<?php the_title(); ?> - <?php the_permalink(); ?>"></a></div>
	<div class="wdt fb"> <a class="addthis_button_facebook_like" fb:like:layout="box_count" addthis:url="<?php the_permalink(); ?>"  addthis:title="<?php the_title(); ?> - <?php the_permalink(); ?>"></a> </div>
